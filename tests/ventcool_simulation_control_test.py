# coding=utf-8
from honeybee_energy.ventcool.simulation_control import VentilationSimulationControl
...
def test_simulation_control_init():
    ...
    assert vent.reference_barometric_pressure == pytest.approx(101320, abs=1e-10)
    ...
    with pytest.raises(AssertionError):
        vent.reference_barometric_pressure = 120000.001
    with pytest.raises(AssertionError):
...
def test_simulation_control_lockability():
    ...
    ventilation.reference_barometric_pressure = 101340
    ventilation.lock()
    with pytest.raises(AttributeError):
        ventilation.reference_barometric_pressure = 30999
    ventilation.unlock()
    ventilation.reference_barometric_pressure = 31000
...
def test_ventilation_dict_methods():
    ...
    new_ventilation.reference_barometric_pressure == \
