...
class VentilationSimulationControl(object):
    ...
    Args:
        vent_control_type: Text indicating type of ventilation control.
            ...
            * MultiZoneWithDistributionOnlyDuringFanOperation
            ...
            which is generally more accurate then the SingleZone option, but requires
            defining more ventilation parameters to explicitly account for weather
            and building-induced pressure differences, and the leakage geometry
            corresponding to specific windows, doors, and surface cracks.
            (Default: 'SingleZone').
        ...
        reference_barometric_pressure: Reference barometric pressure measurement in
    ...
    __slots__ = ('_vent_control_type', '_reference_temperature',
                 '_reference_barometric_pressure', '_reference_humidity_ratio',
    ...
    def __init__(self, vent_control_type='SingleZone', reference_temperature=20,
                 reference_barometric_pressure=101320, reference_humidity_ratio=0,
        ...
        self.reference_barometric_pressure = reference_barometric_pressure
    ...
    def reference_temperature(self, value):
        assert isinstance(value, (int, float)), 'reference_temperature must be ' \
            'a number. Got: {}.'.format(value)
    ...
    def reference_barometric_pressure(self):
        ...
        return self._reference_barometric_pressure

    @reference_barometric_pressure.setter
    def reference_barometric_pressure(self, value):
        assert 31000 <= value <= 120000, 'reference_barometric_pressure must be ' \
            'a number between 31,000 and 120,000, inclusive. Got: {}.'.format(value)
        self._reference_barometric_pressure = value
    ...
    def reference_humidity_ratio(self, value):
        assert value >= 0, 'reference_humidity_ratio must be a number greater than ' \
            'or equal to 0. Got: {}.'.format(value)
        self._reference_humidity_ratio = value
    ...
    def long_axis_angle(self, value):
        assert 0 <= value <= 180, 'The long_axis_angle must be greater than 0 and ' \
            'less than 180, inclusive. Got: {}.'.format(value)
        self._long_axis_angle = value
    ...
    def aspect_ratio(self, value):
        assert 0 < value <= 1, 'The aspect_ratio must be greater than 0 and less than' \
            '1. Got: {}.'.format(value)
    ...
    def from_dict(cls, data):
        ...
        .. code-block:: python
            ...
            "reference_barometric_pressure": 101320 # reference crack barometric pressure
        ...
        ref_pres = data['reference_barometric_pressure'] if \
            'reference_barometric_pressure' in data and \
            data['reference_barometric_pressure'] is not None else 101320
    ...
    def to_dict(self):
        ...
        base['reference_barometric_pressure'] = self.reference_barometric_pressure
    ...
    def __copy__(self):
        return VentilationSimulationControl(
            ...
            self.reference_barometric_pressure, self.reference_humidity_ratio,
