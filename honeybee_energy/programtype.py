...
class ProgramType(object):
    ...
    @classmethod
    def from_standards_dict(cls, data, data_schedules):
        """Create an ProgramType from an OpenStudio standards gem dictionary.
        ...
        Args:
            ...
            data_schedules: Dictionary representation of all schedules in the
                OpenStudio standards gem. Each schedule should have the scheule
                name as a key and the value should be a list of individual
                ScheduleDay dictionary descriptions from the standards gem that
                together define a complete ScheduleRuleset.
        """
        ...
        if data['occupancy_schedule'] is not None:
            ...
            act_sched = ScheduleRuleset.from_standards_dict(
                data_schedules[data['occupancy_activity_schedule']])
        ...
        if data['heating_setpoint_schedule'] is not None:
            ...
            cool_sched = ScheduleRuleset.from_standards_dict(
                data_schedules[data['cooling_setpoint_schedule']])
            setpoint = Setpoint(
