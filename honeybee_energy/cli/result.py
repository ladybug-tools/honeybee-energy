...
@click.option('--output-file', help='Optional file to output the JSON matrix of '
...
@click.option('--normalize/--no-normalize', help='Flag to note whether the data in the '
              'resulting CSV should be normalized by floor area (in the case of '
              'Zone/System data) or surface area (in the case of Surface data). This '
              'flag has no effect if the requested data is not normalizable',
              default=True, show_default=True)
@click.option('--folder', help='Folder on this computer, into which the CSV '
...
@click.option('--log-file', help='Optional file to output the names of the '
