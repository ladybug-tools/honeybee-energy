...
class ModelEnergyProperties(object):
    ...
    ERROR_MAP = {
        ...
        '020102': 'check_all_air_boundaries_with_window',
    ...
    def check_all_air_boundaries_with_window(self, raise_exception=True, detailed=False):
        ...
        This is a requirement for EnergyPlus simulation since EnergyPlus will throw
            ...
            if all(len(f.apertures) > 0 for f in non_ab):
                if len(non_ab) != 0:
                    ...
                    msg = self.host._validation_message_child(
                        msg, room, detailed, '020102',
                        error_type='Room with Window Composed of AirBoundaries')
                    msgs.append(msg)
        if detailed:
            return msgs
        full_msg = '\n'.join(msgs)
